...
import { readRegion, readCinema, myCinema, DelmyCinema, viewCinema } from "../../modules/cinema";
...
const CinemaContainer = () => {
    ...
    const {region, cinema, user, viewcinema} = useSelector(({cinema, user, loading}) => ({
    ...
    return(
        <Cinema cinema={cinema} region={region} mycinema={viewcinema} user={user} onCreate={onCreate} onDelete={onDelete} ownPost={ownPost}/>
    )
