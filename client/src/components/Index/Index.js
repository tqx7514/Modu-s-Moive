...
const Index = () => {
  ...
  const Indexcarousel = currentmovielist.currentmovielist;
  ...
  return (
    <>
      <IndexCarousel currentmovielist={Indexcarousel} />;
      <MovielistCarousel currentmovielist={Indexcarousel} />
      <MainInfo>
        ...
        <div className="main_cont_wrap notice">
          ...
          <div className="rolling_menu_wrap">
            <ul className="rolling_menu">
              <li>
                <Link>롯데시네마 영상정보처리기기 운영 및 관리방침 개정 안내</Link>
              </li>
            </ul>
          </div>
          <button className="btn_txt_more ty2">더보기</button>
